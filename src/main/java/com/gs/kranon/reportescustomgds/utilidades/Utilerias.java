...
public class Utilerias {
    ...
    //Para Wind
	 ...
	 // private String vsPathConf = ReporteMail.pathConfig+ File.separator +"conf.properties";
	 // private String vsPathConfId = ReporteMail.pathConfig+ File.separator +"confclientid.properties" ;
