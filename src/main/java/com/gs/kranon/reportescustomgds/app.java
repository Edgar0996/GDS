...
public class app {
    ...
    public static void main(String[] args) {
    	...
    	Map<String,String> voMapConf = RecuperaArhivoConf();
    	...
    	}else
    	{
    		...
    		int totalThreads= Integer.parseInt(Threads);
    		int totalNoClienteID= Integer.parseInt(NoClienteID);
    		if (totalThreads > totalNoClienteID) {
    			voLogger.error("[Reporteador][" + vsUUI + "] ---> LA CONFIGURACIÓN DE CLIENTES Y HILOS NO ES CORRECTA");
    	}else {
    ...
    public static Map<String,String>  RecuperaArhivoConf(){
